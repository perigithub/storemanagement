...
* The original package name 'com.newproject.mobile-store' is invalid and this project uses 'com.newproject.mobilestore' instead.
...
* [Spring HATEOAS](https://docs.spring.io/spring-boot/docs/2.7.15/reference/htmlsingle/index.html#web.spring-hateoas)
